...
/// <summary>
/// Base SQLite de una campana (colab.db junto a los JSONL). El JSONL es la
/// fuente primaria (write-through); la base se rellena al vuelo y
/// <see cref="Rebuild"/> la regenera entera desde los JSONL.
/// </summary>
public sealed class Store : IDisposable
{
    ...
    /// <summary>Vacia la base y la rellena desde runs.jsonl, samples.jsonl y guard.jsonl del directorio.</summary>
