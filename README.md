...
+- Curve Optimizer ---------------------------------------------------------------------------------------------+
| status         PROFILE APPLIED   validating   guard pid 22668 since 23:02   11.1 h guarded   0 WHEA   0 resets |
...
| profile        not applied                                                                                    |
| auto           on   battery profile 15 s after unplugging, restored on AC                                     |
+---------------------------------------------------------------------------------------------------------------+
