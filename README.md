...
rycolab status [--follow]     one panel with everything applied: Curve Optimizer (guard, phase, per-core),
                              battery profile, Lenovo EC (needs sudo; hints otherwise), Windows scheme
