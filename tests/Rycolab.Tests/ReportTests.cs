...
public class PowerReportTests
{
    ...
    public void BuildSummarisesAcAndBattery()
    {
        List<TickRow> ticks =
        [
            Tick(0, true, 10, mode: 3, ecCpu: 50),
            Tick(1, true, 20, mode: 3, ecCpu: 60),
            Tick(2, true, 30, mode: 3, ecCpu: 70),
            Tick(3, false, 8, batW: 10, batWh: 60, pct: 75, mode: 1, gpu: 1, hz: 60, ecCpu: 45),
            Tick(4, false, 6, batW: 12, batWh: 59.8, pct: 74.8, mode: 1, gpu: 1, hz: 60, ecCpu: 41),
        ];
        ...
        Assert.Contains("| 2026-09-01 10:03 | 0.0 | 0.2 | 11.0 | 75 -> 75 | quiet | igpu-only | 60 | 40 |", md);
